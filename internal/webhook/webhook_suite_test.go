...
var _ = BeforeSuite(func() {
	...
	mgr.GetWebhookServer().Register("/validate-krakends", &webhook.Admission{Handler: &KrakendsValidator{client: mgr.GetClient(), decoder: admission.NewDecoder(testEnv.Scheme)}})
